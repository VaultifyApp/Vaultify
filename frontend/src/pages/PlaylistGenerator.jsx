                ...
                {lengthType === "songs" ? (
                    <div className="form-group">
                        ...
                        <div className="length-options">
                            ...
                            <button onClick={() => setIsModalOpen(true)} className={typeof length === "number" && length > 50 ? "selected" : ""}>
                                {typeof length === "number" && length > 50 ? `Custom` : "Custom"}
                            </button>
                        </div>
                    </div>
                ) : (
                    <div className="form-group">
                        ...
                        <div className="length-options">
                            ...
                            <button onClick={() => setIsModalOpen(true)} className={typeof length === "number" && length > 180 ? "selected" : ""}>
                                {typeof length === "number" && length > 180 ? `Custom` : "Custom"}
                            </button>
                        </div>
                    </div>
                )}
